...
namespace EbayPlatform.Utility.Extensions
{
    ...
    {
        /// <summary>
        /// 表达式 True 类似于Sql 中的 1=1
        /// </summary>
        /// <typeparam name="TEntity">返回实体类型</typeparam>
        /// <returns></returns>
        public static Expression<Func<TEntity, bool>> True<TEntity>() { return item => true; }
        ...
        /// <typeparam name="TEntity">返回实体类型</typeparam>
        /// <returns></returns>
        public static Expression<Func<TEntity, bool>> False<TEntity>() { return item => false; }
